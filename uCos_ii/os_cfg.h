...
#define OS_EVENT_NAME_EN          1    /* Determine the size of the name of a Sem, Mutex, Mbox or Q    */
...
#define OS_TASK_NAME_EN           1    /*     Determine the size of a task name                        */
...
#define OS_FLAG_NAME_EN           1    /*     Determine the size of the name of an event flag group    */
...
#define OS_MEM_NAME_EN            1    /*     Determine the size of a memory partition name            */
